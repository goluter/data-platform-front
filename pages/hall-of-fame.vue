<template>
  <div>
    ...
    <div v-if="point == true">
      <div class="point-box">
        <div class="pt-5 d-flex justify-space-between">
          <div class="pl-3 pt-2">포인트 어떻게 해야 얻을 수 있지?</div>
      ...
      <div v-for="(a, i) in pointData" :key="a" class="contents">
    ...
    <div v-if="nickname == true">
      <div class="point-box">
        <div class="pt-5 d-flex justify-space-between">
          <div class="pl-3 pt-2">칭호 어떻게 해야 얻을 수 있지?</div>
          <div class="mr-3 pa-2 click-box">
            <NuxtLink
              to="/title-list"
              style="color: black; text-decoration-line: none"
      ...
      <div v-for="(a, i) in titleData" :key="a" class="contents">
        <img class="profileimg" src="../assets/Male User.png" align="middle" />
    ...
    <div v-if="achieve == true">
      <div class="point-box">
        <div class="pt-5 d-flex justify-space-between">
          <div class="pl-3 pt-2">업적 어떻게 해야 얻을 수 있지?</div>
          <div class="mr-3 pa-2 click-box">
            <NuxtLink
              to="/reward-list"
              style="color: black; text-decoration-line: none"
      ...
      <div v-for="(a, i) in rewardData" :key="a" class="contents">
        <img class="profileimg" src="../assets/Male User.png" align="middle" />
    ...
    fetchData(page, limit) {
      axios
        .all([
          ...
          axios.get(
            '/users/v1/rewards/rankings?page=' +
              this.page +
              '&limit=' +
              this.limit +
