  ...
  <div class="wrapper">
    ...
    >
          ...
          <v-col class="ma-auto" cols="12" sm="4" mb="4">
            <div class="payment-method d-flex flex-column">
              ...
              <div class="balance-box">
                <div class="balance">
                  <v-row>
                    <v-col class="pb-0" cols="auto"> 소유 포인트: </v-col>
      ...
      <v-row class="ma-auto">
        <v-col
          cols="12"
          class="place-order d-flex justify-center"
        ...
        >
          ...
          >
            <b style="color: white">{{ sum() | comma }} P 결제하기</b>
          </NuxtLink>
        </v-col>
      </v-row>
    </v-container>
...
export default {
  ...
  data() {
    return {
      storeData: [{ title: '[스타벅스] 카페 아메리카노 T', price: 4000 }],
      balanceData: 324324,
    }
  },
  mounted() {
