    ...
    >
      <v-container>
        ...
        <v-row style="background-color: white">
          <v-col cols="12" style="font-size: 12px">
            <b>주문 내용 및 결제조건을 확인했으며, 결제 진행에 동의합니다.</b>
          </v-col>
        </v-row>
      </v-container>
      <v-row class="ma-auto">
        <v-col cols="12">
          <v-row>
            <v-col
              ...
              style="background-color: #515151; border-radius: 5px"
            >
              <NuxtLink
                to="/store/pay/completed/"
                style="text-decoration: none; color: white"
              >
                <b style="color: white">구매 확정</b>
              </NuxtLink>
            </v-col>
          </v-row>
          <v-row>
...
export default {
  ...
  mounted() {
    this.$store.commit('setPageTitle', '구매 확정')
  },
}
</script>
