            ...
            <v-col cols="7">
              <v-card>
                ...
                <v-tabs-slider color="teal lighten-3"></v-tabs-slider>
                  ...
                  <v-tab style="color:black"><NuxtLink to="/list" style="color:black; text-decoration-line: none;">{{tabs[2]}}</NuxtLink></v-tab>
                ...
                <v-row>
                  ...
                  >
                    <v-card
                      ...
                      tile
                    >
                      <span style="font-size:25px;">설문을 참여하고 보상을 받아가세요!</span>
                    </v-card>
                  </v-col>
                </v-row>
                <br><br>
            ...
            <div class="ma-5 pa-5">
              <v-container class="blue lighten-1 rounded-xl">
                ...
                <v-row justify="end">
                  <v-col
                    md="6"
                    class="ml-md-auto blue lighten-1"
                  >
                    <v-card
                      class="pa-2 blue lighten-1"
                      outlined
