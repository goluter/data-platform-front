    ...
    <v-row>
      <v-col cols="12">
        ...
        >
          ...
          <v-tab v-for="(item, i) in tabsData"
                 :key="i"
        ...
        <v-tabs-items v-model="tab">
          <v-tab-item>
            <div class="achievement"
                 ...
                 :key="i"
            >
              <h4 class="achievement-text">@{{ username }}님이 <h4 style="display: inline; color:red">{{ item }}</h4> 업적을 남기셨습니다</h4>
              <v-divider></v-divider>
            </div>
          </v-tab-item>
          <v-tab-item>
            <survey-card :survey-data="surveyData"></survey-card>
          </v-tab-item>
          <v-tab-item>
            <survey-card :survey-data="surveyData"></survey-card>
          </v-tab-item>
...
export default {
  ...
  mounted () {
    this.$store.commit('setPageTitle', 'jooyoung')
  },
  data () {
    return {
      tab: null,
